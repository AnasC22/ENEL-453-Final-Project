...
#
# Script generated by Vivado on Tue Dec 02 14:36:27 -0700 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : seven_segment_display_subsystem.sh
...
#
# Usage        : seven_segment_display_subsystem.sh
#                seven_segment_display_subsystem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                seven_segment_display_subsystem.sh [-reset_run]
#                seven_segment_display_subsystem.sh [-reset_log]
#                seven_segment_display_subsystem.sh [-help]
#
...
# script info
echo -e "seven_segment_display_subsystem.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./seven_segment_display_subsystem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot seven_segment_display_subsystem xil_defaultlib.seven_segment_display_subsystem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim seven_segment_display_subsystem -key {Behavioral:sim_1:Functional:seven_segment_display_subsystem} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb seven_segment_display_subsystem.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./seven_segment_display_subsystem.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: seven_segment_display_subsystem.sh [-help]\n\
Usage: seven_segment_display_subsystem.sh [-step]\n\
Usage: seven_segment_display_subsystem.sh [-lib_map_path]\n\
Usage: seven_segment_display_subsystem.sh [-reset_run]\n\
Usage: seven_segment_display_subsystem.sh [-reset_log]\n\
Usage: seven_segment_display_subsystem.sh [-keep_index]\n\
Usage: seven_segment_display_subsystem.sh [-noclean_files]\n\n\
