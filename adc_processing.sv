...
module adc_processing #(
    parameter int SCALING_FACTOR = 412,
    ...
    output logic [15:0] scaled_adc_data_xadc,
...
//    );
    ...
    always_ff @(posedge clk) begin
        if (reset) begin
            ...
            scaled_adc_data_xadc     <= scaled_adc_data_pipe; // Additional register faciliates pipelining, if needed, for
