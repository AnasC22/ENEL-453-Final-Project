...
module adc_processing_pwm #(
    parameter int SCALING_FACTOR = 415,
    parameter int SHIFT_FACTOR   = 13
) (
    input  logic        clk,
    input  logic        reset,
    input  logic        ready_out,
    input  logic [15:0] pwm_data,
    output logic [15:0] scaled_adc_data_pwm,
...
//    );
    ...
    always_ff @(posedge clk) begin
        if (reset) begin
            ...
            scaled_adc_data_pwm      <= scaled_adc_data_pipe; // Additional register faciliates pipelining, if needed, for
