...
## Switches
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports {nbin_bcd_select[0]}]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {nbin_bcd_select[1]}]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {ncal_switch}]
...
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports {nsar_switch}]
set_property -dict { PACKAGE_PIN T1    IOSTANDARD LVCMOS33 } [get_ports {nmode_select[0]}]
set_property -dict { PACKAGE_PIN R2    IOSTANDARD LVCMOS33 } [get_ports {nmode_select[1]}]
...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports ncal_trig];
...
##Pmod Header JXADC
set_property -dict { PACKAGE_PIN J3   IOSTANDARD LVCMOS33 } [get_ports pwm];#Sch name = XA1_P # [get_ports {JXADC[0]}];
set_property -dict { PACKAGE_PIN L3   IOSTANDARD LVCMOS33 } [get_ports {ncompare_state2}];#Sch name = XA2_P
set_property -dict { PACKAGE_PIN M2   IOSTANDARD LVCMOS33 } [get_ports {ncompare_state1}];#Sch name = XA3_P
...
#set_property -dict { PACKAGE_PIN M1   IOSTANDARD LVCMOS33 } [get_ports {compare_state1}];#Sch name = XA3_N
